...
class PLSegNet(pl.LightningModule):
    def __init__(self, kernel_sizes=[3, 3, 3, 3], down_filter_sizes=[32, 64, 128, 256],
            up_filter_sizes=[128, 64, 32, 32], conv_paddings=[1, 1, 1, 1],
            pooling_kernel_sizes=[2, 2, 2, 2], pooling_strides=[2, 2, 2, 2], 
            in_channels:int=3, out_classes:int = 3, class_weights:torch.Tensor=None, dropout_prob=0.2):
        super(PLSegNet, self).__init__()
        self.model = SegNetLite(kernel_sizes=kernel_sizes, 
                                down_filter_sizes=down_filter_sizes, 
                                up_filter_sizes=up_filter_sizes,
...
class SegnetWithIndex(PLSegNet):
    def __init__(self, kernel_sizes=[3, 3, 3, 3], down_filter_sizes=[32, 64, 128, 256], up_filter_sizes=[128, 64, 32, 32], conv_paddings=[1, 1, 1, 1], pooling_kernel_sizes=[2, 2, 2, 2], pooling_strides=[2, 2, 2, 2], in_channels: int = 3, out_classes: int = 3, class_weights: torch.Tensor = None, dropout_prob: float =0.2):
        super().__init__(kernel_sizes, down_filter_sizes, up_filter_sizes, conv_paddings, pooling_kernel_sizes, pooling_strides, in_channels, out_classes, class_weights, dropout_prob=dropout_prob)
